...
//
//	/** The fields. */
//	ArrayList<LmisColumn> fields = null;
//
//	/** The table name. */
...
//
//	/** The oe_obj. */
//	private static LmisHelper oe_obj = null;
//
//	LmisUser mUser = null;
//
//	/**
...
//		mUser = LmisAccountManager.currentUser(context);
//		if (mUser != null) {
...
//		try {
//			openerp = new LmisHelper(context, mUser);
//		} catch (Exception e) {
//
//		}
//		return openerp;
...
//	 *            the field
//	 */
//	public void handleMany2ManyCol(BaseDBHelper db, LmisColumn field) {
...
//
//				LmisColumn dField = new LmisColumn(field.getName(),
...
//				cols.add(new LmisColumn(tab1_col, tab1_col, OETypes.integer()));
//				cols.add(new LmisColumn(tab2_col, tab2_col, OETypes.integer()));
//				cols.add(new LmisColumn(common_col, "Android Name", OETypes
//						.text()));
...
//	 * @return the sQL statement
//	 */
//	private SQLStatement createStatement(String table, List<LmisColumn> fields) {
//		SQLStatement statement = new SQLStatement();
//		StringBuffer sql = new StringBuffer();
//		sql.append("CREATE TABLE IF NOT EXISTS ");
//		sql.append(table);
//		sql.append(" (");
//		for (LmisColumn field : fields) {
//			try {
...
//		create.append(" (");
//		for (LmisColumn field : this.fields) {
//
...
//		}
//
//		for (LmisColumn field : dbHelper.getColumns()) {
...
//	 * @return the list
//	 */
//	public List<LmisDataRow> search(BaseDBHelper db) {
...
//	 * @return the list
//	 */
//	public List<LmisDataRow> search(BaseDBHelper db, String[] where,
//			String[] whereArgs) {
...
//	 * @return the list
//	 */
//	public List<LmisDataRow> search(BaseDBHelper db, String[] columns,
...
//
//		List<LmisDataRow> returnVals = new ArrayList<LmisDataRow>();
//
...
//		SQLiteDatabase db = getWritableDatabase();
//		try {
//			if (LmisServerConnection.isNetworkAvailable(context)) {
...
//	 * @return the list
//	 */
//	private List<LmisDataRow> executeQuery(BaseDBHelper dbHelper,
...
//		} else {
//			for (LmisColumn col : dbHelper.getColumns()) {
...
//				having, orderby);
//		List<LmisDataRow> data = getResult(dbHelper, columns, cursor);
//		db.close();
//		return data;
//	}
//
...
//	 * @return the list
//	 */
//	public List<LmisDataRow> executeSQL(String sqlQuery, String[] args) {
//		SQLiteDatabase db = getWritableDatabase();
//
//		List<LmisDataRow> data = new ArrayList<LmisDataRow>();
//
...
//	 * @return the result
//	 */
//	private List<LmisDataRow> getResult(BaseDBHelper dbHelper,
...
//		List<LmisDataRow> results = new ArrayList<LmisDataRow>();
...
//							List<LmisDataRow> rel_row = newdb.search(newdb,
//									new String[] { col1 + " = ?", "AND",
//											col3 + " = ?" }, new String[] { id,
//											user_name });
...
//									LmisDataRow rowdata = rel_row.get(i);
//									BaseDBHelper rel_obj = m2mObj
//											.getM2mObject();
//									List<LmisDataRow> rel_data = rel_obj.search(
//											rel_obj,
//											new String[] { "id = ? " },
...
//								JSONArray ids = new JSONArray();
//								List<LmisDataRow> rel_data = m2oObj
//										.getM2OObject().search(
//												m2oObj.getM2OObject(),
//												new String[] { "id", "name" },
//												new String[] { "id = ? " },
...
//		newdb.columns = new ArrayList<LmisColumn>();
...
//		newdb.columns.add(new LmisColumn(col1, col1, OETypes.integer()));
//		newdb.columns.add(new LmisColumn(col2, col2, OETypes.integer()));
//		newdb.columns.add(new LmisColumn(col3, col3, OETypes.text()));
//		return newdb;
//	}
//
//	/**
...
//	 * @return the string[]
//	 */
//	public String[] columnListToStringArray(List<LmisColumn> cols) {
...
//				+ " WHERE oea_name = ?";
//		List<LmisDataRow> records = executeSQL(sql, new String[] { user_name });
//		int[] ids = new int[records.size()];
//		int i = 0;
//		for (LmisDataRow row : records) {
//			ids[i] = row.getInt("id");
//			i++;
//		}
//		return ids;
