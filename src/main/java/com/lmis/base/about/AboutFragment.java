...
public class AboutFragment extends BaseFragment {
	...
	View rootView = null;
	LmisTextView versionName = null, aboutLine2 = null, aboutLine3 = null,
			aboutLine4 = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(com.lmis.R.layout.fragment_about_company, container,
				false);
		versionName = (LmisTextView) rootView.findViewById(com.lmis.R.id.txvVersionName);
		...
		try {
			...
			aboutLine2 = (LmisTextView) rootView.findViewById(com.lmis.R.id.line2);
			if (aboutLine2 != null) {
				aboutLine2.setMovementMethod(LinkMovementMethod.getInstance());
			}
			aboutLine3 = (LmisTextView) rootView.findViewById(com.lmis.R.id.line3);
			if (aboutLine3 != null) {
				aboutLine3.setMovementMethod(LinkMovementMethod.getInstance());
			}
			aboutLine4 = (LmisTextView) rootView.findViewById(com.lmis.R.id.line4);
			if (aboutLine4 != null) {
