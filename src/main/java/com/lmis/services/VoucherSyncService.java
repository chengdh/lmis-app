...
import com.lmis.addons.voucher.VoucherDB;
...
public class VoucherSyncService extends Service {
  ...
  /** The Constant TAG. */
  public static final String TAG = "VoucherSyncService";
  ...
  public void performSync(Context context, Account account, Bundle extras,
    ...
    try {
      ...
      LmisHelper oe = voucherDb.getOEInstance();
      if (oe == null) {
        return;
      }
  ...
  //更新数据库中已有的expense信息
  private List<Integer> updateOldVouchers(VoucherDB db, LmisHelper oe,LmisUser user, List<Integer> ids) {
