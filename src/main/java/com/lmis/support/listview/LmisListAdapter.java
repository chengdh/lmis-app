...
public class LmisListAdapter extends ArrayAdapter<Object> {
    public static final String TAG = "LmisListAdapter";
    ...
    public LmisListAdapter(Context context, int resource, List<Object> objects) {
        super(context, resource, objects);
        Log.d(TAG, "LmisListAdapter->constructor()");
        mContext = context;
    ...
    public void notifiyDataChange(List<Object> objects) {
        Log.d(TAG, "LmisListAdapter->notifiyDataChange()");
        mAllObjects = new ArrayList<Object>(objects);
        mObjects = new ArrayList<Object>(objects);
