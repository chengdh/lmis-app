...
public class TextViewTags {
	...
	public CharSequence generate() {
		...
		for (String tag : mTokens) {
			LmisTextView txvTag = createTokenTextView(" " + tag + " ");
	...
	private LmisTextView createTokenTextView(String text) {
		LmisTextView tv = new LmisTextView(mContext);
		tv.setText(text);
	...
	private Object convertViewToDrawable(LmisTextView view) {
