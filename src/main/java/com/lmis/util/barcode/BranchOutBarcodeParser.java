 ...
 */
public class BranchOutBarcodeParser extends BarcodeParser {
    /**
     ...
     */
    public BranchOutBarcodeParser(Context context, int move_id, int fromOrgId, int toOrgId) {
        super(context, move_id, fromOrgId, toOrgId, true, false, InventoryMoveOpType.BRANCH_OUT);
    }

    @Override
    public void addBarcode(String barcode) throws InvalidBarcodeException, InvalidToOrgException, DBException, BarcodeDuplicateException {
