 ...
 * 
 */
package com.lmis.util.contactview;
...
import com.lmis.support.contact.LmisContact;

public class LmisContactView extends QuickContactBadge {

    public static final String TAG = "LmisContactView";

    int mPartner_id = 0;
    Uri mContactUri = null;
    LmisContact mContact = null;
    Context mContext = null;
    LmisUser mUser = null;

    public LmisContactView(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public LmisContactView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }

    public LmisContactView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        mContact = new LmisContact(mContext, mUser);
    }
                ...
                .setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                LmisDataRow partner = new ResPartnerDB(mContext)
                                        .select(partner_id);
