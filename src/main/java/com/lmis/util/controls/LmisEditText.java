...
public class LmisEditText extends EditText {
	Context mContext = null;

	public LmisEditText(Context context) {
		super(context);
		mContext = context;
		setTypeFace("light");
	}

	public LmisEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setTypeFace(getTextStyle(attrs));
	}

	public LmisEditText(Context context, AttributeSet attrs, int defStyle) {
