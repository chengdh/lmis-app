...
public class LmisTextView extends TextView {
	Context mContext = null;

	public LmisTextView(Context context) {
		super(context);
		mContext = context;
		setTypeFace("light");
	}

	public LmisTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setTypeFace(getTextStyle(attrs));
	}

	public LmisTextView(Context context, AttributeSet attrs, int defStyle) {
