...
public class LmisCheckBox extends CheckBox {
    Context mContext = null;

    public LmisCheckBox(Context context) {
        super(context);
        mContext = context;
        setTypeFace("light");
    }

    public LmisCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setTypeFace(getTextStyle(attrs));
    }

    public LmisCheckBox(Context context, AttributeSet attrs, int defStyle) {
