...
public class LmisButton extends Button {
    Context mContext = null;

    public LmisButton(Context context) {
        super(context);
        mContext = context;
        setTypeFace("light");
    }

    public LmisButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setTypeFace(getTextStyle(attrs));
    }

    public LmisButton(Context context, AttributeSet attrs, int defStyle) {
