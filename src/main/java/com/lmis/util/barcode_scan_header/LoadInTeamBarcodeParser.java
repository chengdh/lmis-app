...
public class LoadInTeamBarcodeParser extends BarcodeParser {
     ...
     */
    public LoadInTeamBarcodeParser(Context context, int id, int fromOrgID, int toOrgID) {
        super(context, id, fromOrgID, toOrgID, false, false, ScanHeaderOpType.LOAD_IN_TEAM);
    }
    ...
    @Subscribe
    public void onLoadInTeamGetBillFromServerSuccessEvent(LoadInTeamGetBillFromServerSuccessEvent evt) throws InvalidToOrgException, DBException, BarcodeNotExistsException, BarcodeDuplicateException {
