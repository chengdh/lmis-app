...
public class InnerTransitLoadInBarcodeParser extends BarcodeParser {
     ...
     */
    public InnerTransitLoadInBarcodeParser(Context context, int id, int fromOrgID, int toOrgID) {
        super(context, id, fromOrgID, toOrgID, false, false, ScanHeaderOpType.INNER_TRANSIT_LOAD_IN);
    }
    ...
    @Subscribe
    public void onInnerTransitLoadInGetBillFromServerSuccessEvent(InnerTransitLoadInGetBillFromServerSuccessEvent evt) throws InvalidToOrgException, DBException, BarcodeNotExistsException, BarcodeDuplicateException {
