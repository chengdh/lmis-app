...
public class LocalTownLoadInBarcodeParser extends BarcodeParser {
     ...
     */
    public LocalTownLoadInBarcodeParser(Context context, int id, int fromOrgID, int toOrgID) {
        super(context, id, fromOrgID, toOrgID, false, false, ScanHeaderOpType.LOCAL_TOWN_LOAD_IN);
    }
    ...
    @Subscribe
    public void onLoadInGetBillFromServerSuccessEvent(LocalTownLoadInGetBillFromServerSuccessEvent evt) throws InvalidToOrgException, DBException, BarcodeNotExistsException, BarcodeDuplicateException {
