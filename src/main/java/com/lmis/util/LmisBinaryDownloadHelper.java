...
public class LmisBinaryDownloadHelper {
    ...
    public void downloadBinary(int id, LmisDatabase db, Context context) {
        Log.d(TAG, "LmisBinaryDownloadHelper->downloadBinary()");
        mContext = context;
        try {
            if (LmisServerConnection.isNetworkAvailable(mContext)) {
    ...
    private class DownloadTask extends AsyncTask<Integer, Integer, Boolean> {
        ...
        int attachment_id = 0;
        LmisDatabase db = null;
        String downloadPath = "";
        String downloadFileName = "";

        public DownloadTask(LmisDatabase db) {
            this.db = db;
        }
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (!result) {
                ...
                Toast.makeText(mContext, "File downloaded", Toast.LENGTH_SHORT)
                        .show();
                LmisNotificationHelper notification = new LmisNotificationHelper();
                ...
                notification.showNotification(mContext, downloadFileName
                        ...
                        com.lmis.R.drawable.ic_stat_av_download
                );
