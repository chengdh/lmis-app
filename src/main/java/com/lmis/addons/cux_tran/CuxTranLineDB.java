...
public class CuxTranLineDB extends LmisDatabase{
    ...
    public List<LmisColumn> getModelColumns() {
        ...
        cols.add(new LmisColumn("item_spc", "item spec", LmisFields.varchar(60), true));
        cols.add(new LmisColumn("uom", "unit measure", LmisFields.varchar(60), true));
        cols.add(new LmisColumn("subinventory", "subinventory", LmisFields.varchar(60), true));
        cols.add(new LmisColumn("required_qty", "required qty", LmisFields.integer(16), true));

        cols.add(new LmisColumn("project_number", "project number", LmisFields.varchar(30), true));
        ...
        //物料名称
        cols.add(new LmisColumn("item_dec", "item dec", LmisFields.varchar(30), true));


        //备注
        cols.add(new LmisColumn("remark", "remark", LmisFields.varchar(60), true));


        cols.add(new LmisColumn("project_id", "project id", LmisFields.integer(16), true));
        cols.add(new LmisColumn("task_id", "task id", LmisFields.integer(16), true));
        cols.add(new LmisColumn("expense_type", "expense type", LmisFields.varchar(60), true));
        cols.add(new LmisColumn("cost", "cost", LmisFields.varchar(60), true));


        cols.add(new LmisColumn("wip_entity_name", "wip entiry name", LmisFields.varchar(60), true));
        cols.add(new LmisColumn("operation_seq_num", "operation seq num", LmisFields.integer(16), true));
        cols.add(new LmisColumn("canceled_qty", "canceled qty", LmisFields.integer(16), true));
